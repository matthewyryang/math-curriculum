...
export MODEL_PATH="/project/flame/asetlur/checkpoints/math-curriculum/Math/24klen-qwen3easy8k-medium2500-b128mb64n16-kl2e-3/global_step_100/actor/hf-format"
