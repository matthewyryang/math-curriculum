...
# export EXPERIMENT_NAME="eval24k-8klen-qwen3--ent0.002-crh0.5l0.2-step100-omnimath"
export EXPERIMENT_NAME="eval32k-16klen-qwen3-medhard-crh0.5-aime"
...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=/project/flame/asetlur/data/aime.parquet \
    data.val_files=/project/flame/asetlur/data/aime.parquet \
