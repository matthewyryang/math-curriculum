...
num_models=${#models[@]}
names=(
    aime-deepseekdistill-grpo-8k-aime
    aime-deepseekdistill-grpo-8k-omnimath
    aime-deepseekdistill-grpo-8k-dapo
    aime-deepseekdistill-grpo-8k-deepscaler
)
num_names=${#names[@]}
...
PROJECT_NAME='verl_stable_grpo_codev2_0424'
...
for i in $(seq 0 $((num_models-1))); do
    ...
    command="bash /home/anikait.singh/verl-stable/scripts/grpo/grpo_run.sh"
