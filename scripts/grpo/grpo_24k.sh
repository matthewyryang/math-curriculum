...
export EXPERIMENT_NAME="24klen-qwen3easy-medium500_3"
...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=$HOME/math-curriculum/data/medium_500_3.parquet \
    data.val_files=$HOME/math-curriculum/data/test_rand_500.parquet \
    ...
    trainer.total_epochs=100 "${@:1}" > /home/asetlur/math-curriculum/logs/$EXPERIMENT_NAME.log 2>&1