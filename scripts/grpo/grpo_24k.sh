...
export EXPERIMENT_NAME="24klen-qwen3easy8kmed16k-hard"

export MODEL_PATH="/project/flame/asetlur/checkpoints/math-curriculum/Math/16klen-qwen3easy8k-medium2500-medium2500set2/global_step_25/actor/hf-format"

# Train over 4 nodes, 8 A100-80GB GPUs per node.
source /home/asetlur/miniconda3/bin/activate verl 
python3 -m verl.trainer.main_ppo \
    algorithm.adv_estimator=grpo \
    data.train_files=/project/flame/asetlur/data/hard.parquet \
