...
export EXPERIMENT_NAME="16klen-qwen3easy8koldckpt-medium5000-b128mb64n16genmb32-crh0.35l0.2"
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.rollout_micro_batch_size=32 \
    ...
    trainer.save_freq=8 \
    trainer.test_freq=1 \
    trainer.total_epochs=400 "${@:1}" > /home/asetlur/math-curriculum/logs/$EXPERIMENT_NAME.log 2>&1
    # trainer.resume_mode='resume_path' \
    # trainer.resume_from_path="/project/flame/asetlur/checkpoints/math-curriculum/Math/16klen-qwen3easy8koldckpt-medium2500-b320mb160n16genmb64-crh0.35l0.2/global_step_48" \
